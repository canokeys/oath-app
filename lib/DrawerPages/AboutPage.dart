    ...
    return Scaffold(
      ...
      body: Column(
        children: <Widget>[
          ...
          ListTile(
            title: Streambuilder(
                'github', TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
            subtitle: InkWell(
              child: Text('https://github.com/canokeys/oath-app',
          ...
          ListTile(
            title: Streambuilder(
                'email', TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
            subtitle: InkWell(
              child: Text('2088083463@qq.com',
                  style: TextStyle(fontSize: 16, color: Colors.blue)),
              onTap: () async {
