...
class Tutorial {
  ...
  static void initTargets() {
    LanguageBloc.targets.add(TargetFocus(
    ...
    addBottomBarHelp(
        LanguageBloc.key3, "bottom_scan", CrossAxisAlignment.center);
    addBottomBarHelp(
        LanguageBloc.key4, "bottom_refresh", CrossAxisAlignment.end);
  }

  static void addBottomBarHelp(
      GlobalKey key, String info, CrossAxisAlignment alignment) {
    LanguageBloc.targets
        .add(TargetFocus(keyTarget: key, enableOverlayTab: true, contents: [
      ContentTarget(
